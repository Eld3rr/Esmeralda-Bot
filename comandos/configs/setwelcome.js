    ...
    message.channel.send(msg11).then(msg => {
        ...
        .on('collect', c => {
            ...
            if(!canal) {
                ...
                .addField("Exemplo:", "e!setwelcome <#canal>")
                    ...
                    .on('collect', c => {
                        ...
                        message.channel.send(msg33).then(msg3 => {
                            ...
                            .on('collect', c => {
                                ...
                                .setAuthor("Setado!")
                                .setDescription("Foi setado com o sucesso, a mensagem de Boas Vindas!")
                                message.channel.send(sucesso)

                                    db.ref(`Configuração/Entrada/${message.guild.id}/Canal`).set(canal.id)
                                    db.ref(`Configuração/Entrada/${message.guild.id}/Mensagem`).set(desc)
                                    db.ref(`Configuração/Entrada/${message.guild.id}/Título`).set(title)
                            });
                        });
                    });
                });
    ...
    message.channel.send(msg11).then(msg => {
        ...
        .on('collect', c => {
            ...
            if(!canal) {
                ...
                let msg22 = new Discord.MessageEmbed()
                .setDescription("What message do you want, to be sent after someone enters?")
                    ...
                    .on('collect', c => {
                        ...
                        message.channel.send(msg33).then(msg3 => {
                            ...
                            .on('collect', c => {
                                ...
                                let sucesso = new Discord.MessageEmbed()
                                .setAuthor("Setado!")
                                .setDescription("It was set with success, the message of Input!")
                                message.channel.send(sucesso)
...
exports.help = {
    name: 'setwelcome',
    aliases: ['setwel', 'setentrada', 'welcome']
}
